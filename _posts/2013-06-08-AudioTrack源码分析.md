...
<pre><code>AudioTrack.getMinBufferSize(8000,//每秒8K个点
	AudioFormat.CHANNEL_CONFIGURATION_STEREO,//双声道
	AudioFormat.ENCODING_PCM_16BIT);
...
<pre><code>audio_track_cblk_t::audio_track_cblk_t()
...
<pre><code>static void audioCallback(int event, void* user, void *info) {
...
#####4.2 write
<pre><code>ssize_t AudioTrack::write(const void* buffer, size_t userSize)
